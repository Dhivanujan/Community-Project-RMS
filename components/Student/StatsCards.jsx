...
export default function StatsCards({ data }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      ...
      <div className="relative bg-gradient-to-br from-[#1e3a5f] via-[#264d7a] to-[#1a3355] text-white rounded-2xl p-6 overflow-hidden shadow-lg shadow-[#1e3a5f]/15 group hover:shadow-xl hover:shadow-[#1e3a5f]/20 transition-all duration-300">
        {/* Decorative elements */}
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200/60 shadow-sm hover:shadow-md hover:border-slate-200 transition-all duration-300 group">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="w-9 h-9 rounded-lg bg-[#1e3a5f]/[0.07] flex items-center justify-center group-hover:bg-[#1e3a5f]/[0.10] transition-colors">
      ...
      <div className="bg-white rounded-2xl p-6 border border-slate-200/60 shadow-sm hover:shadow-md hover:border-slate-200 transition-all duration-300 group">
        ...
        <a
          ...
          className="inline-flex items-center gap-1 text-[#1e3a5f] text-xs font-semibold hover:text-[#2d5a8e] transition-colors group/link"
        >
