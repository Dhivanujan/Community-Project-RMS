        ...
        <div className="md:w-1/2 bg-blue-600 p-10 lg:p-12 text-white flex flex-col relative overflow-hidden">
          ...
          <div className="bg-white text-slate-800 rounded-2xl p-5 shadow-xl relative z-10 w-full max-w-[320px] mt-12 md:mt-0">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <div className="font-bold text-sm text-slate-900">Dr. Arthur Sterling</div>
          ...
          <form className="flex flex-col flex-1" onSubmit={(e) => e.preventDefault()}>
            <div className={`space-y-${isLogin ? '5' : '4'}`}>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full relative group bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl font-semibold text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600 flex items-center justify-center gap-2"
                >
