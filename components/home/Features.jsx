    ...
    <section id="features" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Feature 1 */}
          <div className="bg-surface p-8 rounded-xl border border-border hover-lift group cursor-pointer">
            <div className="w-12 h-12 bg-blue-50 text-primary rounded-lg flex items-center justify-center text-xl mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:bg-primary group-hover:text-white">
              <i className="fa-solid fa-calculator"></i>
            </div>
            <h3 className="font-bold text-lg mb-3 transition-colors group-hover:text-primary">GPA Automation</h3>
          ...
          <div className="bg-surface p-8 rounded-xl border border-border hover-lift group cursor-pointer">
            ...
            <h3 className="font-bold text-lg mb-3 transition-colors group-hover:text-primary">Academic Ranking</h3>
          ...
          <div className="bg-surface p-8 rounded-xl border border-border hover-lift group cursor-pointer">
            ...
            <h3 className="font-bold text-lg mb-3 transition-colors group-hover:text-primary">Class Identification</h3>
          ...
          <div className="bg-surface p-8 rounded-xl border border-border hover-lift group cursor-pointer">
            ...
            <h3 className="font-bold text-lg mb-3 transition-colors group-hover:text-primary">Early Warning System</h3>
