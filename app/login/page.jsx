...
import { GraduationCap, Mail, Lock, Eye, EyeOff, ArrowRight, HelpCircle, User, AlertCircle } from "lucide-react";
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="/forgot-password" size="sm" className="text-xs font-semibold text-blue-600 hover:text-blue-700 transition-colors">
                    Forgot?
                  </Link>
                </div>
                <div className="relative">
