...
export default function UsersPage() {
  ...
  const [createForm, setCreateForm] = useState({ fullName: "", username: "", email: "", role: "STAFF", department: "", password: "" });
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setShowCreate(false); setCreateForm({ fullName: "", username: "", email: "", role: "STAFF", department: "", password: "" });
        fetchUsers();
