          ...
          <div className="max-w-7xl mx-auto px-6 h-full flex items-center">
            <div className="max-w-4xl">
              ...
              <p className="mt-6 text-slate-300 text-lg leading-relaxed">
                The Department of Computing and Information Systems focuses on
                enterprise systems, cybersecurity, and digital infrastructure.
                Students develop skills in information management, cloud
                platforms, and technology leadership to drive modern
        ...
        <section className="mb-16">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
            ...
            <p className="text-slate-300 leading-8 text-lg mb-5">
              The Department of Computing and Information Systems delivers a
              modern curriculum that blends information systems design, cloud
              computing, cybersecurity, and enterprise architecture.
            </p>

            <p className="text-slate-300 leading-8 text-lg">
              The department emphasizes applied learning, industry engagement,
              and digital transformation skills to prepare graduates for
              leadership roles in IT and business technology.
            </p>
          </div>
        </section>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                ...
                <tbody>
                  ...
                  <tr className="border-t border-slate-800">
                    <td className="p-5">
                      Industry Training and Enterprise Projects
                    </td>
